...
async function connectMongoDB() {
  await mongoose.connect('mongodb+srv://code94:code94_1234@cluster0.ioecl5j.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0');
...
app.use('/people', require('./route/people.route'));
